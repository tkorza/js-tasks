...
const num__1: number = 23
const num__2: number = 56

let sum1: number = Math.floor(num__1 / 10) + num__1 % 10
let sum2: number = Math.floor(num__2 / 10) + num__2 % 10

if (sum1 === sum2) console.log('имеют равную сумму');
else if (sum1 > sum2) console.log(`${num__1} имеет большую суммму`);
else console.log(`${num__2} имеет большую суммму`)
